...
const env = {
  ...
  dynamodb: {
    usersTable: process.env.DYNAMODB_TABLE_USERS || 'UrbanShield-Users-dev',
    reportsTable: process.env.DYNAMODB_TABLE_REPORTS || 'UrbanShield-Reports-dev',
    notificationsTable: process.env.DYNAMODB_TABLE_NOTIFICATIONS || 'UrbanShield-Notifications-dev',
    activityLogsTable: process.env.DYNAMODB_TABLE_ACTIVITY_LOGS || 'UrbanShield-ActivityLogs-dev',
    supportMessagesTable: process.env.DYNAMODB_TABLE_SUPPORT_MESSAGES || 'UrbanShield-SupportMessages-dev',
  },
  s3: {
